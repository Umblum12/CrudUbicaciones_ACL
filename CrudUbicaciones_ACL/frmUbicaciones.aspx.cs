...
namespace CrudUbicaciones_ACL
{
    public partial class frmUbicaciones : System.Web.UI.Page
    {
        ...
        protected void EliminarRegisttro(object sender, EventArgs e)
        {
            oUbicacionesDAL = new ubicacionesDALL();
            oUbicacionesDAL.Eliminar(datosUbicacion());
            ListarUbicaciones();
        }
        protected void ModificarRegisttro(object sender, EventArgs e)
        {
            oUbicacionesDAL = new ubicacionesDALL();
            oUbicacionesDAL.Modificar(datosUbicacion());
            ListarUbicaciones();
        }
        protected void LimpiarRegisttro(object sender, EventArgs e)
        {
